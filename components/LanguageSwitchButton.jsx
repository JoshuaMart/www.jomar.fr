...
export default function LanguageSwitchButton() {
	...
	return (
		<LanguageWrapper>
			<Image src="/img/frfr.png" alt="Bandeira do Brasil" width={28} height={28} objectFit="cover" />
			<SwitchButton>
				<label className="switch">
					<input type="checkbox" checked={checked} onClick={handleCheckSwitch} readOnly data-splitbee-event="language-change" aria-label="language-change" />
